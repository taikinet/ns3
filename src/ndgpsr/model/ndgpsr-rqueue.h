...
#ifndef NDGPSR_RQUEUE_H
#define NDGPSR_RQUEUE_H
...
/**
 * \ingroup ndgpsr
 * \brief NDGPSR route request queue
 *
 * Since NDGPSR is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
