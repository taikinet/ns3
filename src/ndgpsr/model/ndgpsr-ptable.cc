...
NS_LOG_COMPONENT_DEFINE ("NDGpsrTable");
...
/**
 * \brief Gets next hop according to NDGPSR protocol
...
/**
 * \brief Gets next hop according to NDGPSR recovery-mode protocol (right hand rule)
