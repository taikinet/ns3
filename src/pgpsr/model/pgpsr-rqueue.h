...
#ifndef PGPSR_RQUEUE_H
#define PGPSR_RQUEUE_H
...
/**
 * \ingroup pgpsr
 * \brief PGPSR route request queue
 *
 * Since PGPSR is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
