...
TypeHeader::TypeHeader (MessageType t = DGPSRTYPE_HELLO)
  : m_type (t),
    m_valid (true)
{
}
...
{
  static TypeId tid = TypeId ("ns3::dgpsr::TypeHeader")
    .SetParent<Header> ()
...
{
  static TypeId tid = TypeId ("ns3::dgpsr::HelloHeader")
    .SetParent<Header> ()
...
{
  static TypeId tid = TypeId ("ns3::dgpsr::PositionHeader")
    .SetParent<Header> ()
