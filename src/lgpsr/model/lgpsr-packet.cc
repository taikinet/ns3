...
#include "lgpsr-packet.h"
#include "ns3/address-utils.h"
#include "ns3/packet.h"
#include "ns3/log.h"

NS_LOG_COMPONENT_DEFINE ("LGpsrPacket");
...
TypeHeader::TypeHeader (MessageType t = LGPSRTYPE_HELLO)
  : m_type (t),
    m_valid (true)
{
}
...
{
  static TypeId tid = TypeId ("ns3::lgpsr::TypeHeader")
    .SetParent<Header> ()
...
HelloHeader::HelloHeader (uint64_t originPosx, uint64_t originPosy,uint64_t f_originPosx, uint64_t f_originPosy)
  : m_originPosx (originPosx),
    ...
    f_originPosx (f_originPosx),//追加
    f_originPosy (f_originPosy)//追加
...
{
  static TypeId tid = TypeId ("ns3::lgpsr::HelloHeader")
    .SetParent<Header> ()
...
HelloHeader::Serialize (Buffer::Iterator i) const
{
  ...
  i.WriteHtonU64 (f_originPosx);//追加
  i.WriteHtonU64 (f_originPosy);//追加
...
HelloHeader::Deserialize (Buffer::Iterator start)
{
  ...
  f_originPosx = i.ReadNtohU64 ();//追加
  f_originPosy = i.ReadNtohU64 ();//追加
...
{
  static TypeId tid = TypeId ("ns3::lgpsr::PositionHeader")
    .SetParent<Header> ()
