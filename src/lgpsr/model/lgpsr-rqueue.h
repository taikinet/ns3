...
#ifndef LGPSR_RQUEUE_H
#define LGPSR_RQUEUE_H
...
/**
 * \ingroup lgpsr
 * \brief LGPSR route request queue
 *
 * Since LGPSR is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
