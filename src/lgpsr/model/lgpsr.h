 ...
 * \ingroup lgpsr
 *
 * \brief lgpsr routing protocol
 */
class RoutingProtocol : public Ipv4RoutingProtocol
{
public:
  static TypeId GetTypeId (void);
  static const uint32_t LGPSR_PORT;
  ...
  virtual void RecvLGPSR (Ptr<Socket> socket);
