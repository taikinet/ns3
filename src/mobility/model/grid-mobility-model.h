 ...
 */
#ifndef GRID_MOBILITY_MODEL_H
#define GRID__MOBILITY_MODEL_H
 ...
 */
class GridMobilityModel : public MobilityModel
...
//  virtual int64_t DoAssignStreams (int64_t);
  ...
  int m_flag;//追加
//  std::vector< std::vector<int> > coordinate;//変更
  //uint32_t divNumXY;//変更
};

} // namespace ns3

#endif /* GRID_MOBILITY_MODEL_H */
