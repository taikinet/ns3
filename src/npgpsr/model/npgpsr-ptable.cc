...
NS_LOG_COMPONENT_DEFINE ("NPGpsrTable");
...
/**
 * \brief Gets next hop according to NPGPSR protocol
...
/**
 * \brief Gets next hop according to NPGPSR recovery-mode protocol (right hand rule)
