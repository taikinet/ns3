...
class DoubleDiffractionLossModel : public PropagationLossModel
{
public:
  /**
...
private:
  ...
  // 標高計算
  void DoCalcElevation(VegeData& vstruct)const;
  
  
  // ルート判定
  void DeterminePath(VegeData& vstrut)const;
  
  // 
  void DetermineArea(VegeData&  vstruct)const;
  
  // 
  double DoCalcVegetationalDistance(VegeData&  vstruct_a, VegeData&  vstruct_b)const;
