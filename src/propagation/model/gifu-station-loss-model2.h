#ifndef GIFU_STATION_PROPAGATIONI_LOSS_MODEL2_H
#define GIFU_STATION_PROPAGATIONI_LOSS_MODEL2_H
...
namespace ns3 {
	class GifuStationPropagationLossModel2 : public PropagationLossModel
	{
		public:
		
		static TypeId GetTypeId (void);
		GifuStationPropagationLossModel2 ();
