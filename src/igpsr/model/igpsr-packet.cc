...
#include "igpsr-packet.h"
#include "ns3/address-utils.h"
#include "ns3/packet.h"
#include "ns3/log.h"

NS_LOG_COMPONENT_DEFINE ("IgpsrPacket");
...
TypeHeader::TypeHeader (MessageType t = IGPSRTYPE_HELLO)
  : m_type (t),
    m_valid (true)
{
}
...
{
  static TypeId tid = TypeId ("ns3::igpsr::TypeHeader")
    .SetParent<Header> ()
...
*///追加開始
HelloHeader::HelloHeader (uint64_t originPosx, uint64_t originPosy, uint64_t pNumNeighbor)
  : m_originPosx (originPosx),
    m_originPosy (originPosy),
...
{
  static TypeId tid = TypeId ("ns3::igpsr::HelloHeader")
    .SetParent<Header> ()
...
HelloHeader::Serialize (Buffer::Iterator i) const
{
  ...
  i.WriteHtonU64(m_pNumNeighbor);//追加
...
HelloHeader::Deserialize (Buffer::Iterator start)
{
  ...
  m_pNumNeighbor=i.ReadNtohU64 ();//追加
...
{
  static TypeId tid = TypeId ("ns3::igpsr::PositionHeader")
    .SetParent<Header> ()
