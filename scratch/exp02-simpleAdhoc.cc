...
NetSim::ConfigureDataLinkLayer(bool verbose, StringValue phyMode, double dist)
{
	...
	wifiChannel.SetPropagationDelay ("ns3::ConstantSpeedPropagationDelayModel"); //定常速度遅延モデル
	wifiChannel.AddPropagationLoss  ("ns3::LogDistancePropagationLossModel",   //対数距離伝搬損失モデル
