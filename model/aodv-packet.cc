...
void
RreqHeader::Serialize(Buffer::Iterator i) const     // シリアライズの実行
{
    i.WriteU8(m_flags);
...
RreqHeader::Print(std::ostream& os) const
{
    os << "RREQ ID " << m_requestID << " destination: ipv4 " << m_dst << " sequence number "
       ...
       << " bandwidth " << m_bandwidth << " delay " << m_delay << " E " << m_E;
}
...
RreqHeader::operator==(const RreqHeader& o) const
{
    return (m_flags == o.m_flags && m_reserved == o.m_reserved && m_hopCount == o.m_hopCount &&
            ...
            m_origin == o.m_origin && m_originSeqNo == o.m_originSeqNo && m_bandwidth == o.m_bandwidth && m_delay == o.m_delay && m_E == o.m_E);
}
