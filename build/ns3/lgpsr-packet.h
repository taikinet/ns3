...
#ifndef LGPSRPACKET_H
#define LGPSRPACKET_H
...
enum MessageType
{
  LGPSRTYPE_HELLO  = 1,         //!< LGPSRTYPE_HELLO
  LGPSRTYPE_POS = 2,            //!< LGPSRTYPE_POS
};
...
private:
  ...
  uint64_t         f_originPosx; //追加         ///< Originator Position x
  uint64_t         f_originPosy; //追加        ///< Originator Position x
};
