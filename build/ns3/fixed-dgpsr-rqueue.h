...
#ifndef FIXED_DGPSR_RQUEUE_H
#define FIXED_DGPSR_RQUEUE_H
...
/**
 * \ingroup dgpsr
 * \brief DGPSR route request queue
 *
 * Since DGPSR is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
