	...
	#ifndef MOUNTAIN_PROPAGATION_LOSS_MODEL_REV_H
	#define MOUNTAIN_PROPAGATION_LOSS_MODEL_REV_H
	...
	class MountainPropagationLossModelRev : public PropagationLossModel
	{
	public:
	/**
	...
	*/
	...
	MountainPropagationLossModelRev ();
	/**
	* \param frequency (Hz)
	*
	...
	*/
	...
	// 標高計算
	void DoCalcElevation(VegetationDataRev& vstruct)const;


	// ルート判定
	void DeterminePath(VegetationDataRev& vstrut)const;

	// 
	void DetermineArea(VegetationDataRev&  vstruct)const;

	// 
	double DoCalcVegetationalDistance(VegetationDataRev&  vstruct_a, VegetationDataRev&  vstruct_b)const;
