...
#ifndef IGPSR_RQUEUE_H
#define IGPSR_RQUEUE_H
...
/**
 * \ingroup igpsr
 * \brief IGPSR route request queue
 *
 * Since IGPSR is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
