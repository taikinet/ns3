 ...
 * \ingroup igpsr
 *
 * \brief IGPSR routing protocol
 */
class RoutingProtocol : public Ipv4RoutingProtocol
{
public:
  static TypeId GetTypeId (void);
  static const uint32_t IGPSR_PORT;
  ...
  virtual void RecvIGPSR (Ptr<Socket> socket);
  //virtual void UpdateRouteToNeighbor (Ipv4Address sender, Ipv4Address receiver, Vector Pos);
  virtual void UpdateRouteToNeighbor (Ipv4Address sender, Ipv4Address receiver, Vector Pos, uint64_t M1HopNumNeighbor);//追加
