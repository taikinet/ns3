 ...
 */
#ifndef FIXED_DGPSRHELPER_H_
#define FIXED_DGPSRHELPER_H_
...
/**
 * \ingroup dgpsr
 * \brief Helper class that adds DGPSR routing to nodes.
 */
class DGpsrHelper : public Ipv4RoutingHelper
{
public:
  DGpsrHelper ();
   ...
   *
   * TODO: support installing DGPSR on the subset of all available IP interfaces
   */
   ...
   *
   * This method controls the attributes of ns3::dgpsr::RoutingProtocol
   */
