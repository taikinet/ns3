...
#ifndef NPGPSR_RQUEUE_H
#define NPGPSR_RQUEUE_H
...
/**
 * \ingroup npgpsr
 * \brief NPGPSR route request queue
 *
 * Since NPGPSR is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
