 ...
 */
#ifndef NPGPSRHELPER_H_
#define NPGPSRHELPER_H_
...
/**
 * \ingroup npgpsr
 * \brief Helper class that adds NPGPSR routing to nodes.
 */
class NPGpsrHelper : public Ipv4RoutingHelper
{
public:
  NPGpsrHelper ();
   ...
   *
   * TODO: support installing NPGPSR on the subset of all available IP interfaces
   */
   ...
   *
   * This method controls the attributes of ns3::npgpsr::RoutingProtocol
   */
