#ifndef FIXED_DGPSR_PTABLE_H
#define FIXED_DGPSR_PTABLE_H
...
/*
 * \ingroup dgpsr
 * \brief Position table used by DGPSR
 */
class PositionTable
{
public:
  ...
  /**
   * \brief Gets next hop according to DGPSR protocol
  ...
  /**
   * \brief Gets next hop according to DGPSR recovery-mode protocol (right hand rule)
