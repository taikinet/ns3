...
#ifndef NGPSR_RQUEUE_H
#define NGPSR_RQUEUE_H
...
/**
 * \ingroup ngpsr
 * \brief NGPSR route request queue
 *
 * Since NGPSR is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
